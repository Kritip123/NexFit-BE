...
import org.example.trainerhub.repository.TrainerAvailabilityRepository;
import org.example.trainerhub.repository.TrainerRepository;
import org.example.trainerhub.service.TrainerService;
import org.example.trainerhub.util.DistanceCalculator;
...
public class TrainerServiceImpl implements TrainerService {
    ...
    private MatchedTrainerResponse buildMatch(Trainer trainer, TrainerMatchRequest request) {
        ...
        if (request.getTrainerGender() != null) {
            if (request.getTrainerGender() == org.example.trainerhub.entity.User.TrainerGenderPreference.NO_PREFERENCE) {
                score += 10;
            } else if (trainer.getGender() != null) {
                boolean matches = (request.getTrainerGender() == org.example.trainerhub.entity.User.TrainerGenderPreference.MALE
                        && trainer.getGender() == org.example.trainerhub.entity.User.Gender.MALE)
                        || (request.getTrainerGender() == org.example.trainerhub.entity.User.TrainerGenderPreference.FEMALE
                        && trainer.getGender() == org.example.trainerhub.entity.User.Gender.FEMALE);
                if (matches) {
                    score += 10;
                }
            }
